pub(in crate::ui::tab::pages::settings) const GROUP_BOX_MARGIN: i32 = 10;
pub(in crate::ui::tab::pages::settings) const GROUP_BOX_TITLE_BAR_HEIGHT: i32 = 20;
pub(in crate::ui::tab::pages::settings) const GROUP_BOX_INTERNAL_PADDING: i32 = 6;

pub(in crate::ui::tab::pages::settings) const CHECKBOX_HEIGHT: i32 = 22;
...
pub(in crate::ui::tab::pages::settings) const BUTTON_HEIGHT: i32 = 25;
pub(in crate::ui::tab::pages::settings) const BUTTON_HORIZONTAL_GAP: i32 = 5;
